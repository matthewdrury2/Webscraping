...
### 1 stands for row 1, 2 stands for column B ###
print(sheet1.cell(1, 2).value)

### gives number of rows and columns in sheet ### ### also the last row and last column with data in it ###
...
### given column number, gets corresponding letter for column ###
print(xl.utils.get_column_letter(1))
print(xl.utils.get_column_letter(900))

### given column letter, gets corresponding number for column ###
