...
### GOOD EXAMPLE FOR EXAM: SCRAPING STUFF ONLINE AND PUTTING IT INTO EXCEL, (LIKE THE TOP MOVIES DONE IN CLASS) ###
...
### FOR EVERY CELL IN COLUMN C, change cell to number format ###
